...
export default function About() {
  ...
  return (
    <div className="space-y-4 max-w-4xl mx-auto pb-6 select-none animate-fade-in font-sans">
          ...
          <div className="divide-y divide-zinc-100 dark:divide-zinc-850/80 text-xs">
            ...
            <div className="flex items-center justify-between py-2.5 first:pt-0 last:pb-0">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <span className="font-bold text-zinc-850 dark:text-zinc-100 block leading-tight">Tauri Core Engine v2</span>
            ...
            <div className="flex items-center justify-between py-2.5 first:pt-0 last:pb-0">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <span className="font-bold text-zinc-850 dark:text-zinc-100 block leading-tight">React 18 & TypeScript</span>
            ...
            <div className="flex items-center justify-between py-2.5 first:pt-0 last:pb-0">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <span className="font-bold text-zinc-850 dark:text-zinc-100 block leading-tight">Tailwind CSS & Headless UI</span>
            ...
            <div className="flex items-center justify-between py-2.5 first:pt-0 last:pb-0">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <span className="font-bold text-zinc-850 dark:text-zinc-100 block leading-tight">SQLite & Zustand Store</span>
      ...
      <div className="flex flex-col items-center justify-center gap-1 pt-4 text-center text-[10px] text-zinc-400 dark:text-zinc-500 border-t border-zinc-100 dark:border-zinc-850">
