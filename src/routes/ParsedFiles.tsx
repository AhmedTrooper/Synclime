        ...
        {parsedFiles.map((file) => (
          ...
          >
            ...
            <Link
              ...
              className="flex items-center justify-center gap-1.5 w-full sm:w-auto px-3 py-2.5 sm:py-1.5 rounded-md bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-300 font-medium transition-colors text-[11px] sm:text-[11px] flex-shrink-0"
            >
              Details
